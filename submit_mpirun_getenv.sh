...
#SBATCH --output=log_mpirun_getenv_%j.log     # Path to the standard output and error files relative to the working directory
...
echo 
echo submit_mpirun_cuda_mpi_getenv.sh

mpirun -np 4 /blue/roitberg/jinzexue/dev/cuda_mpi_rank/cuda_mpi_rank_getenv
