...
#SBATCH --output=log_srun_split_%j.log     # Path to the standard output and error files relative to the working directory
...
echo 
echo submit_srun_cuda_mpi_split.sh

srun --mpi=pmix_v3 /blue/roitberg/jinzexue/dev/cuda_mpi_rank/cuda_mpi_rank_split
